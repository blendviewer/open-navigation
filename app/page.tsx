...
import { aiTools, getToolsByCategory, getToolsBySubcategory, getFeaturedTools, searchTools, categories, getCategoriesWithCounts } from "@/data/ai-tools";
            ...
            <div className="p-6 border-b border-gray-200 dark:border-gray-700">
              <div className="flex items-center justify-between">
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">我的收藏夹</h2>
                    <p className="text-sm text-gray-500 dark:text-gray-400">已收藏 {favorites.length} 个工具</p>
                  </div>
                </div>
                <button
            ...
            <div className="px-6 pt-6 pb-0 overflow-y-auto max-h-[calc(85vh-120px)]">
              {!isClient ? (
                      ...
                      return (
                        ...
                        >
                          <div className="relative">
                            ...
                            {/* 收藏夹专用列表布局 */}
                            <div className={`relative bg-white/95 dark:bg-slate-900/95 backdrop-blur-lg rounded-xl border border-slate-200 dark:border-slate-700 ${theme.hoverBorder} shadow-md hover:shadow-xl transition-all duration-300 overflow-hidden card-shimmer`}>
                              {/* 背景装饰渐变 */}
                              <div className={`absolute inset-0 bg-gradient-to-br ${theme.gradient} opacity-60 pointer-events-none`}></div>
                              ...
                              <div className="p-4 relative">
                                <div className="flex items-center space-x-4">
                                  ...
                                  <div className="flex-shrink-0">
                                    <div className={`w-14 h-14 bg-gradient-to-br ${theme.iconBg} rounded-xl flex items-center justify-center border border-white/20 dark:border-gray-700/20 shadow-inner transition-all duration-300 group-hover:scale-105 group-hover:rotate-2`}>
                                  ...
                                  <div className="flex-1 min-w-0 space-y-2">
                                    ...
                                    <div className="flex items-center justify-between pt-2">
                                      ...
                                      <div className="flex items-center space-x-2">
                                        ...
                                        >
                                          <svg className="h-3.5 w-3.5 mr-1.5 fill-current" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100 mb-2">还没有收藏任何工具</h3>
                  <p className="text-gray-500 dark:text-gray-400">浏览工具页面，点击❤️按钮来收藏你喜欢的工具</p>
                </div>
              )}
            </div>
          </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-3 gap-6">
                ...
                <div className="bg-gradient-to-br from-blue-50 to-indigo-50 dark:from-blue-950/30 dark:to-indigo-950/30 rounded-xl p-6 border border-blue-200/30 dark:border-blue-700/30">
                  ...
                  <div className="space-y-3">
                    {['AI绘画', 'AI写作', '代码助手', '语音合成', '图像处理'].map((category, index) => (
                      <div key={category} className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-2">
                          ...
                          <span className="text-xs text-gray-500 dark:text-gray-400">{90 - index * 15}%</span>
                        </div>
                      </div>
                    ))}
                  </div>
                ...
                <div className="bg-gradient-to-br from-purple-50 to-pink-50 dark:from-purple-950/30 dark:to-pink-950/30 rounded-xl p-6 border border-purple-200/30 dark:border-purple-700/30">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4 text-center">
                      ...
                      <div>
                        <div className="text-xl font-semibold text-gray-900 dark:text-gray-100">156</div>
              ...
              <div className="mt-8 bg-white dark:bg-gray-800 rounded-xl p-6 border border-gray-200 dark:border-gray-700">
                ...
                <div className="h-64 flex items-end space-x-2">
                  {Array.from({ length: 30 }, (_, i) => (
                    <div key={i} className="flex-1 bg-gradient-to-t from-blue-500 to-blue-300 rounded-t opacity-70 hover:opacity-100 transition-opacity" 
